...
$config['tables']['users_groups']    = 'admin_role';
 ...
 */
$config['site_title']                 = "safecity.com";       // Site Title, example.com
$config['admin_email']                = "no-reply@safecity.in"; // Admin Email, admin@example.com
...
/*
 ...
 | Please customize
 */
$config['session_hash'] = '8b0a2c13afadae59483eadc242a630fa379fa5cf';
...
$config['use_ci_email'] = TRUE; // Send Email using the builtin CI email class, if false it will return the code and the identity
	$config['email_config'] = array(
			...
			'smtp_port' => 465,
			'smtp_user' => 'safecityglobal.org',
			'smtp_pass' => 'j5IYvHVOVWJ7',
			'charset'   => 'utf-8',
			'newline'   => "\r\n"
	);
