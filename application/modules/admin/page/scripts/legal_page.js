$(function() {
    ...
    var dataTableInstance = $('#myTable').DataTable({
                                ...
                                rowId: 'id',
                                ajax: {
                                    url: baseURL+"admin/pages/legal_datatable",
                                    type: "POST",
                                    data: function (d) {
                                ...
                                columns: [
                                    {
                                        ...
                                        render: function(data, type, row, meta) {
                                            ...
                                            var country   = '<div class="table-fs-light">'+row.country_name+'<div>';
                                            var updated_by = '<div>'+row.updated_by+'</div>';
                                            return title+lang+country+updated_by;
                                        },
                                        visible: false
                                    },
                                    {
    ...
    $("#country_filter").change(function(event) {
		...
		$('.modal-title').html('Add New Language For - '+$("#country_filter option:selected").text());
	...
	function getLanguage(country_id) {
        $.ajax({
            url: baseURL+'admin/pages/get-language-details',
            method: 'POST',
    ...
    function fetchReportDetail(id) {
        ...
        $.ajax({
            url: baseURL+'admin/pages/get-legal-details',
            method: 'POST',
            data: {id: id}
        })
        .done(function(data) {
    ...
    function hideEdit() {
        ...
        // Update Text
        $(".table-open__header--title").text('View Legal Resources');
        $(".posted__title").show();
    }
    ...
    $(document).on('click', '#saveChanges', function(event) {
        ...
        // Send Update Request
        var api_endpoint = 'admin/pages/updatelegal';
        $.ajax({
