<?php 
  ...
  $mapH =  (isset($_COOKIE['mapAddHospital']) && !empty($_COOKIE['mapAddHospital']) ? $_COOKIE['mapAddHospital'] : '');
  $mapH = str_replace('"', '', $mapH);
  // echo $mapH;
  // exit();
?>
                  ...
                  <ul class="progress-form">
                    ...
                    <div class="Step1">
                       ...
                       <!-- step1 start -->
                        ...
                        <label for="nameInput">                  
                          <?php echo $this->lang->line('map_hospital_find_loc'); ?>
                        </label>
                        <input type="text" name="txtLocation" id="autocomplete" value="<?php echo $mapH; ?>" class="form-control inputBox txtLocation" placeholder="<?php echo $this->lang->line('map_placeholder'); ?>">
...
<script type="text/javascript" src="assets/js/hospital/find_loc.js"></script>
