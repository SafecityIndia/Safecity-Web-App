var estimateTimeRangePickerField = (function() {
	...
	return function(data, lastQuestion) {
		...
		elementHtml = `<div class="mainTime">
		                  <div class="row">
		                  	<div class="col-md-12">
		                  		<label><h6 class="textColor">${timeform_select_time}</h6></label>
		                  	</div>
		                    ...
		                    <div class="col-md-4 col-sm-4 col-xs-12 col-12">
		                      <a class="clearTime btn animated fadeInUp pull-right mt-0 themeColor">${timeform_clear_time}</a>
		                    </div>
		                  </div>
		                  <div class="custom-control custom-checkbox estimate mb-20">
		                    ...
		                    <label class="custom-control-label eLabel" for="estimate1">${this_is_an_estimate}</label>
		                  </div>
		                </div>

		                <div class="timeRange">
		                  <div class="text-center">
		                    <label class="themeColor">${timeform_time_or}</label>
		                  </div>
		                  <div class="row">
		                    <div class="col-md-12">
		                      <label>
		                        <h6 class="textColor">${timeform_select_a_time_range}</h6>
		                      </label>
		                    </div>
		                    <div class="col-md-12">
		                      <div class="row">
		                        <div class="col-md-12">
		                          <div class="row">
		                            ...
		                            <div class="col-md-4">
		                              <a class="clearTimeRange btn animated fadeInUp pull-right mt-0 themeColor">${timeform_clear_time_range}</a>
		                            </div>
		                          </div>
		                        </div>
		                      </div>
		...
		//to disable editing in textbox of time
