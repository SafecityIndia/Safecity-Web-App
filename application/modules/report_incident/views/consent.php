			...
			<?php
				...
				?>
					<div class="text mx-auto shareIncident">
						<div class="custom-control custom-checkbox agreeConsent" style="padding-left:24px!important"><input type="checkbox" name="agreeConsent" class="custom-control-input" id="agreeConsent"><label class="custom-control-label" for="agreeConsent"><?php echo $this->lang->line('apply_to_agreeConsent'); ?></label></div><div class="mt-4"><a href="privacy_policy" class="themeColor aLink"><?php echo $this->lang->line('apply_to_privacy_policy'); ?></a></div>
