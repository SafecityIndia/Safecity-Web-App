      ...
      try{
          ...
          function listing() {          
              ...
              service.nearbySearch(request,callback =>{
                    ...
                    for (var i = 0; i < markers.length; i++) {
                        ...
                        hospitalHTML += "<div class='add-main'>"+
                                                ...
                                                "<div class='direction-icon text-center'>"+
                                                  "<a href='http://maps.google.com/maps?saddr="+latLong+"&daddr="+latLong1+"'>"+
                    ...
                    locHTML += map_location+" : "+mainAdd+" <a href='policestation_loc' style='padding-left: 10px;color: #592d8d'>"+map_edit_option+"</a>";
